...
/* ΓöÇΓöÇΓöÇ Default Devices (static fallback) ΓöÇΓöÇΓöÇ */
...
/* ΓöÇΓöÇΓöÇ Per-slug styling overrides (keep design data out of DB) ΓöÇΓöÇΓöÇ */
...
export default function HeroMarvel({ items = [] }: { items?: ProductListItem[] }) {
  ...
  /* ΓöÇΓöÇΓöÇ Map Supabase items ΓåÆ HeroDevice ΓöÇΓöÇΓöÇ */
  useEffect(() => {
  ...
  /* ΓöÇΓöÇ Canvas particles ΓöÇΓöÇ */
  useEffect(() => {
  ...
  /* ΓöÇΓöÇ Carousel advance ΓöÇΓöÇ */
  ...
  /* ΓöÇΓöÇ Light sweep on mount ΓöÇΓöÇ */
  useEffect(() => {
  ...
  /* ΓöÇΓöÇ SplitText headline reveal ΓöÇΓöÇ */
  useGSAP(() => {
  ...
  /* ΓöÇΓöÇ Magnetic button effect ΓöÇΓöÇ */
  ...
  return (
    ...
    >
      ...
      {/* Single large accent orb ΓÇö right side, behind device */}
      <motion.div
      ...
      <div ref={stageRef} style={{
        ...
        <motion.div style={{ x: sx, y: sy, display: "flex", flexDirection: "column", justifyContent: "center" }}>
          ...
          <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.45 }}
            ...
            >
              View all devices ΓåÆ
            </Link>
          </motion.div>
        </motion.div>

        {/* ΓöÇΓöÇΓöÇ RIGHT: Device Stage ΓöÇΓöÇΓöÇ */}
